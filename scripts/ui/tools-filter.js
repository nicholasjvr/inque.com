    ...
    this.tools = new Map([
      [
        "cursor",
        {
          ...
          category: "ai-ides",
          description:
            "AI-powered code editor with GPT-4 integration for intelligent code completion and assistance.",
          icon: "⚡",
          rating: 4.8,
          url: "https://cursor.sh",
      ...
      [
        "bolt",
        {
          ...
          category: "ai-ides",
          description:
            "Lightning-fast AI development environment for building full-stack apps in minutes.",
          icon: "🚀",
          rating: 4.6,
          url: "https://bolt.dev",
      ...
      [
        "claude-code",
        {
          ...
          category: "ai-ides",
          description:
            "Anthropic's AI coding assistant that understands your codebase and helps you build better software.",
          icon: "🤖",
          rating: 4.7,
          url: "https://claude.ai",
      ...
      [
        "notion",
        {
          ...
          description:
            "All-in-one workspace for notes, docs, and project management with powerful databases.",
          icon: "📝",
          rating: 4.8,
          url: "https://notion.so",
      ...
      [
        "perplexity",
        {
          ...
          category: "productivity",
          description:
            "AI-powered search engine that provides comprehensive answers with sources.",
          icon: "🔍",
          rating: 4.6,
      ...
      [
        "react-boilerplate",
        {
          ...
          category: "templates",
          description:
            "Production-ready React application template with modern tooling and best practices.",
          icon: "📦",
          rating: 4.7,
      ...
      [
        "nextjs-starter",
        {
          ...
          category: "templates",
          description:
            "Full-stack Next.js application with authentication, database, and deployment ready.",
          icon: "🚀",
          rating: 4.6,
...
window.toolsFilterManager = toolsFilterManager;
