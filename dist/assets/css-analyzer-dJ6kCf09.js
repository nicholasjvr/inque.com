var B={};console.log("[DEBUG] AI Configuration module loaded");console.log("[DEBUG] Environment check - GOOGLE_AI_API_KEY present:",!!B.GOOGLE_AI_API_KEY);const R={GOOGLE_AI_API_KEY:B.GOOGLE_AI_API_KEY,MODEL:"gemini-pro"};var N;(function(e){e.STRING="string",e.NUMBER="number",e.INTEGER="integer",e.BOOLEAN="boolean",e.ARRAY="array",e.OBJECT="object"})(N||(N={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const X="https://generativelanguage.googleapis.com",Q="v1beta",ee="0.24.1",te="genai-js";var E;(function(e){e.GENERATE_CONTENT="generateContent",e.STREAM_GENERATE_CONTENT="streamGenerateContent",e.COUNT_TOKENS="countTokens",e.EMBED_CONTENT="embedContent",e.BATCH_EMBED_CONTENTS="batchEmbedContents"})(E||(E={}));class ne{constructor(n,t,s,i,o){this.model=n,this.task=t,this.apiKey=s,this.stream=i,this.requestOptions=o}toString(){var n,t;const s=((n=this.requestOptions)===null||n===void 0?void 0:n.apiVersion)||Q;let o=`${((t=this.requestOptions)===null||t===void 0?void 0:t.baseUrl)||X}/${s}/${this.model}:${this.task}`;return this.stream&&(o+="?alt=sse"),o}}function se(e){const n=[];return e?.apiClient&&n.push(e.apiClient),n.push(`${te}/${ee}`),n.join(" ")}async function ie(e){var n;const t=new Headers;t.append("Content-Type","application/json"),t.append("x-goog-api-client",se(e.requestOptions)),t.append("x-goog-api-key",e.apiKey);let s=(n=e.requestOptions)===null||n===void 0?void 0:n.customHeaders;if(s){if(!(s instanceof Headers))try{s=new Headers(s)}catch(i){throw new C(`unable to convert customHeaders value ${JSON.stringify(s)} to Headers: ${i.message}`)}for(const[i,o]of s.entries()){if(i==="x-goog-api-key")throw new C(`Cannot set reserved header name ${i}`);if(i==="x-goog-api-client")throw new C(`Header name ${i} can only be set using the apiClient field`);t.append(i,o)}}return t}async function oe(e,n,t,s,i,o){const r=new ne(e,n,t,s,o);return{url:r.toString(),fetchOptions:Object.assign(Object.assign({},le(o)),{method:"POST",headers:await ie(r),body:i})}}async function A(e,n,t,s,i,o={},r=fetch){const{url:a,fetchOptions:c}=await oe(e,n,t,s,i,o);return re(a,c,r)}async function re(e,n,t=fetch){let s;try{s=await t(e,n)}catch(i){ae(i,e)}return s.ok||await ce(s,e),s}function ae(e,n){let t=e;throw t.name==="AbortError"?(t=new W(`Request aborted when fetching ${n.toString()}: ${e.message}`),t.stack=e.stack):e instanceof q||e instanceof C||(t=new g(`Error fetching from ${n.toString()}: ${e.message}`),t.stack=e.stack),t}async function ce(e,n){let t="",s;try{const i=await e.json();t=i.error.message,i.error.details&&(t+=` ${JSON.stringify(i.error.details)}`,s=i.error.details)}catch{}throw new q(`Error fetching from ${n.toString()}: [${e.status} ${e.statusText}] ${t}`,e.status,e.statusText,s)}function le(e){const n={};if(e?.signal!==void 0||e?.timeout>=0){const t=new AbortController;e?.timeout>=0&&setTimeout(()=>t.abort(),e.timeout),e?.signal&&e.signal.addEventListener("abort",()=>{t.abort()}),n.signal=t.signal}return n}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const j=/^data\: (.*)(?:\n\n|\r\r|\r\n\r\n)/;function he(e){const n=e.body.pipeThrough(new TextDecoderStream("utf8",{fatal:!0})),t=me(n),[s,i]=t.tee();return{stream:pe(s),response:ge(i)}}async function ge(e){const n=[],t=e.getReader();for(;;){const{done:s,value:i}=await t.read();if(s)return w(Ce(n));n.push(i)}}function pe(e){return fe(this,arguments,function*(){const t=e.getReader();for(;;){const{value:s,done:i}=yield v(t.read());if(i)break;yield yield v(w(s))}})}function me(e){const n=e.getReader();return new ReadableStream({start(s){let i="";return o();function o(){return n.read().then(({value:r,done:a})=>{if(a){if(i.trim()){s.error(new g("Failed to parse stream"));return}s.close();return}i+=r;let c=i.match(j),l;for(;c;){try{l=JSON.parse(c[1])}catch{s.error(new g(`Error parsing JSON response: "${c[1]}"`));return}s.enqueue(l),i=i.substring(c[0].length),c=i.match(j)}return o()}).catch(r=>{let a=r;throw a.stack=r.stack,a.name==="AbortError"?a=new W("Request aborted when reading from the stream"):a=new g("Error reading from the stream"),a})}}})}function Ce(e){const n=e[e.length-1],t={promptFeedback:n?.promptFeedback};for(const s of e){if(s.candidates){let i=0;for(const o of s.candidates)if(t.candidates||(t.candidates=[]),t.candidates[i]||(t.candidates[i]={index:i}),t.candidates[i].citationMetadata=o.citationMetadata,t.candidates[i].groundingMetadata=o.groundingMetadata,t.candidates[i].finishReason=o.finishReason,t.candidates[i].finishMessage=o.finishMessage,t.candidates[i].safetyRatings=o.safetyRatings,o.content&&o.content.parts){t.candidates[i].content||(t.candidates[i].content={role:o.content.role||"user",parts:[]});const r={};for(const a of o.content.parts)a.text&&(r.text=a.text),a.functionCall&&(r.functionCall=a.functionCall),a.executableCode&&(r.executableCode=a.executableCode),a.codeExecutionResult&&(r.codeExecutionResult=a.codeExecutionResult),Object.keys(r).length===0&&(r.text=""),t.candidates[i].content.parts.push(r)}i++}s.usageMetadata&&(t.usageMetadata=s.usageMetadata)}return t}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function V(e,n,t,s){const i=await A(n,E.STREAM_GENERATE_CONTENT,e,!0,JSON.stringify(t),s);return he(i)}async function J(e,n,t,s){const o=await(await A(n,E.GENERATE_CONTENT,e,!1,JSON.stringify(t),s)).json();return{response:w(o)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Z(e){if(e!=null){if(typeof e=="string")return{role:"system",parts:[{text:e}]};if(e.text)return{role:"system",parts:[e]};if(e.parts)return e.role?e:{role:"system",parts:e.parts}}}function I(e){let n=[];if(typeof e=="string")n=[{text:e}];else for(const t of e)typeof t=="string"?n.push({text:t}):n.push(t);return Ee(n)}function Ee(e){const n={role:"user",parts:[]},t={role:"function",parts:[]};let s=!1,i=!1;for(const o of e)"functionResponse"in o?(t.parts.push(o),i=!0):(n.parts.push(o),s=!0);if(s&&i)throw new g("Within a single message, FunctionResponse cannot be mixed with other type of part in the request for sending chat message.");if(!s&&!i)throw new g("No content is provided for sending chat message.");return s?n:t}function Se(e,n){var t;let s={model:n?.model,generationConfig:n?.generationConfig,safetySettings:n?.safetySettings,tools:n?.tools,toolConfig:n?.toolConfig,systemInstruction:n?.systemInstruction,cachedContent:(t=n?.cachedContent)===null||t===void 0?void 0:t.name,contents:[]};const i=e.generateContentRequest!=null;if(e.contents){if(i)throw new C("CountTokensRequest must have one of contents or generateContentRequest, not both.");s.contents=e.contents}else if(i)s=Object.assign(Object.assign({},s),e.generateContentRequest);else{const o=I(e);s.contents=[o]}return{generateContentRequest:s}}function Y(e){let n;return e.contents?n=e:n={contents:[I(e)]},e.systemInstruction&&(n.systemInstruction=Z(e.systemInstruction)),n}function ye(e){return typeof e=="string"||Array.isArray(e)?{content:I(e)}:e}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const z=["text","inlineData","functionCall","functionResponse","executableCode","codeExecutionResult"],_e={user:["text","inlineData"],function:["functionResponse"],model:["text","functionCall","executableCode","codeExecutionResult"],system:["text"]};function ve(e){let n=!1;for(const t of e){const{role:s,parts:i}=t;if(!n&&s!=="user")throw new g(`First content should be with role 'user', got ${s}`);if(!M.includes(s))throw new g(`Each item should include role field. Got ${s} but valid roles are: ${JSON.stringify(M)}`);if(!Array.isArray(i))throw new g("Content should have 'parts' property with an array of Parts");if(i.length===0)throw new g("Each Content should have at least one part");const o={text:0,inlineData:0,functionCall:0,functionResponse:0,fileData:0,executableCode:0,codeExecutionResult:0};for(const a of i)for(const c of z)c in a&&(o[c]+=1);const r=_e[s];for(const a of z)if(!r.includes(a)&&o[a]>0)throw new g(`Content with role '${s}' can't contain '${a}' part`);n=!0}}function K(e){var n;if(e.candidates===void 0||e.candidates.length===0)return!1;const t=(n=e.candidates[0])===null||n===void 0?void 0:n.content;if(t===void 0||t.parts===void 0||t.parts.length===0)return!1;for(const s of t.parts)if(s===void 0||Object.keys(s).length===0||s.text!==void 0&&s.text==="")return!1;return!0}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ae(e,n,t,s){return(await A(n,E.COUNT_TOKENS,e,!1,JSON.stringify(t),s)).json()}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Oe(e,n,t,s){return(await A(n,E.EMBED_CONTENT,e,!1,JSON.stringify(t),s)).json()}async function Re(e,n,t,s){const i=t.requests.map(r=>Object.assign(Object.assign({},r),{model:n}));return(await A(n,E.BATCH_EMBED_CONTENTS,e,!1,JSON.stringify({requests:i}),s)).json()}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
</head>`)}return i}}import.meta.url===`file://${process.argv[1]}`&&(console.log("[CSS ANALYZER] CSS Analyzer ready for use"),console.log("[CSS ANALYZER] Use this agent to analyze CSS files and optimize styling for widget uploads"));export{Ne as C};
